...
class ContactDataSource extends HttpActions {
  ...
  Future<dynamic> createContact(Map<String, dynamic> paraMeters) async {
    final response = await postMethod(ApiEndPoint.getContactListApi,
  ...
  Future<dynamic> getContactDetail(Map<String, dynamic> paraMeters) async {
    final response = await postMethod(ApiEndPoint.getContactListApi,
        queryParams: paraMeters);
    debugPrint("retrieveContactListApi --- $response");
    return response;
  }

  Future<dynamic> updateContactDetail(Map<String, dynamic> paraMeters) async {
    final response = await postMethod(ApiEndPoint.getContactListApi,
        queryParams: paraMeters);
    debugPrint("updateContactListApi --- $response");
    return response;
  }
}
