      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage(ImageString.imgBackground), fit: BoxFit.cover),
        ),
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(EngineerString.lblJobSchedule,
                      ...
                      child: ClipOval(
                        ...
                        decoration: BoxDecoration(
                            image: const DecorationImage(
                                image: AssetImage(ImageString.imgRound)),
            ...
            if (count == 0)
              Text(EngineerString.lblTodayJobs,
                  style: CustomTextStyle.specialText),
            if (count == 1)
              Text(EngineerString.lblPendingJobSheetList,
                  style: CustomTextStyle.specialText),
            if (count == 2)
              Text(EngineerString.lblUpcomingJobsList,
                  style: CustomTextStyle.specialText),
            Expanded(
              child: Padding(
                padding: EdgeInsets.only(left: 10.sp, right: 10.sp, top: 10.sp, bottom: 0.sp),
                child: Scrollbar(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(
                                left: 7.sp, right: 7.sp, top: 7.sp, bottom: 0),
                            child: Container(
                              width: query.width,
                              decoration: BoxDecoration(
                                  color: AppColors.whiteColor,
                                ...
                                children: [
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                                            SvgPicture.asset(ImageString.icTime,
                                                height: 12.h),
                                            Padding(
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: 5.sp,
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        SizedBox(width: 3.w),
                                        SvgPicture.asset(ImageString.icSubject,
                                            height: 12.h),
                                        SizedBox(width: 4.w),
                                        Text.rich(
                                          TextSpan(
