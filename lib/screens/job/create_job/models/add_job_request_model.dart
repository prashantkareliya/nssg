class CreateJobRequest {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['job_checklist_raise_invoice_number'] = jobChecklistRaiseInvoiceNumber ?? "";
    ...
    data['job_checklist_payment_on_complet'] = jobChecklistPaymentOnComplet ?? "";
    data['job_checklist_extra_stock_allocate'] = jobChecklistExtraStockAllocate ?? "";
    data['job_checklist_extra_stock_return_faulty'] = jobChecklistExtraStockReturnFaulty ?? "";
    ...
    data['job_checklist_urn_received_client'] = jobChecklistUrnReceivedClient ?? "";
    data['job_checklist_urn_appli_police_force'] = jobChecklistUrnAppliPoliceForce ?? "";
    data['job_checklist_urn_received_police_force'] = jobChecklistUrnReceivedPoliceForce ?? "";
    data['job_checklist_mainten_sent_client'] = jobChecklistMaintenSentClient ?? "";
    data['job_checklist_mainten_received'] = jobChecklistMaintenReceived ?? "";
    data['job_checklist_keyholder_sent_client'] = jobChecklistKeyholderSentClient ?? "";
    data['job_checklist_keyholder_received'] = jobChecklistKeyholderReceived ?? "";
    data['job_checklist_cs_digi_check'] = jobChecklistCsDigiCheck ?? "";
    data['job_checklist_cs_digi_number'] = jobChecklistCsDigiNumber ?? "";
    data['job_checklist_issue_nsi_cert_check'] = jobChecklistIssueNsiCertCheck ?? "";
    data['job_checklist_issue_nsi_cert_number'] = jobChecklistIssueNsiCertNumber ?? "";
