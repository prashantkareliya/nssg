class GetSubProductData {
  bool? success;
  List<SubProductResult>? result;

  GetSubProductData({this.success, this.result});

  GetSubProductData.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['result'] != null) {
      result = <SubProductResult>[];
      json['result'].forEach((v) {
        result!.add(new SubProductResult.fromJson(v));
      });
    }
  }
...
class SubProductResult {
  ...
  SubProductResult.fromJson(Map<String, dynamic> json) {
