...
class _SearchAndAddProductState extends State<SearchAndAddProduct> {
  ...
  Padding buildSearchBar(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(right: 24.sp, top: 8.sp, left: 0.sp, bottom: 0),
      child: Padding(
...
//            SizedBox(width: 4.w),
            Expanded(
              child:
                  Consumer<WidgetChange>(builder: (context, updateKey, search) {
                return TextField(
                    autofocus: true,
                    onChanged: (value) {
                      setState(() {});
                    ...
                    itemBuilder: (context, index) {
                      ...
                      double amount = searchKey.isNotEmpty
                          ? (double.parse(searchItemList![index].unitPrice.toString()) *
                                  double.parse(searchItemList![index]
                                      .quantity
                                      .toString()) -
                              double.parse(
                          ...
                          : (double.parse(productItems![index].unitPrice.toString()) *
                                  double.parse(productItems![index]
                                      .quantity
                                      .toString()) -
                              double.parse(
                                  discountPriceController[index].text == ""
                      ...
                      double profit = searchKey.isNotEmpty
                          ? ((double.parse(searchItemList![index].unitPrice!) -
                                      double.parse(searchItemList![index]
                                          .costPrice
                                          .toString())) *
                              ...
                              double.parse(
                                  discountPriceController[index].text == ""
                                      ? "0"
                                      : discountPriceController[index].text))
                          : ((double.parse(productItems![index].unitPrice!) -
                                      double.parse(productItems![index]
                                          .costPrice
                                          .toString())) *
                      ...
                      return BlocConsumer<ProductListBloc, ProductListState>(
                          ...
                          builder: (context, productState) {
                            final bool isItemAdded = searchKey.isNotEmpty
                                ? productState.productList.firstWhereOrNull(
                                        (element) =>
                                            element.productId ==
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child:
                                                            searchKey.isNotEmpty
                                                                ? Image.network(
                                                                    "${ImageBaseUrl.productImageBaseUrl}${searchItemList![index].imagename!.replaceAll("&amp;", "&")}",
                                                                    // height: 10.h,
                                                                    // width: 20.w
                                                                  )
                                                                : Image.network(
                                                                    "${ImageBaseUrl.productImageBaseUrl}${productItems![index].imagename!.replaceAll("&amp;", "&")}",
                                                                    // height: 10.h,
                                                                    // width: 20.w
                                                                  ),
                                                      ),
                                  ...
                                  child: Card(
                                    ...
                                    child: ListTile(
                                      onTap: isItemAdded
                                          ...
                                          : () {
                                              getSubProduct(searchKey.isNotEmpty
                                                  ? searchItemList![index]
                                                      .id
                                                      .toString()
                                                  : productItems![index]
