class CopyQuoteRequest {
  ...
  CopyQuoteRequest.fromJson(Map<String, dynamic> json) {
    ...
    if (json['LineItems'] != null) {
      ...
      json['LineItems'].forEach((v) {
        lineItems!.add(LineItemsCopy.fromJson(v));
      });
    }
  }
...
class LineItemsCopy {
  ...
  LineItemsCopy.fromJson(Map<String, dynamic> json) {
